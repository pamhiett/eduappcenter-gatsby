...
const Footer = () => (
  <Wrapper as="footer" withBorder padding=" small x-small large">
    <Text size="x-small" as="p">
      Learning Tools Interoperability™ (LTI™) is a trademark of the{' '}
      <Link href="http://www.imsglobal.org/">
        IMS Global Learning Consortium, Inc.
      </Link>
      <br/> Official IMS LTI docs are found on the{' '}
      <Link href="http://www.imsglobal.org/lti/">IMS page</Link>. Also check out IMS’s
      <Link href="http://www.imsglobal.org/lti">LTI™ Directory</Link> and
